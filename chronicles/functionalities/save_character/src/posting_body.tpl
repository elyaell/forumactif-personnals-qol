<br/>{ERROR_BOX}
<form id="form_message" action="{S_POST_ACTION}" method="post" name="post" enctype="multipart/form-data">  
    <!----------------------------------------------->
    <!-- ENTETE DE LA PAGE -------------->
            ...
            <fieldset class="fields1" style="min-width: inherit;">              
              <!-- BEGIN switch_username_select -->
                ...
                <dl>
                    ...
                    <dd>
                        <input class="inputbox medium" type="text" id="post_subject" name="subject" value="{SUBJECT}" maxlength="{TOPIC_TITLE_MAXLENGTH}" title="{TOPIC_TITLE_LENGTH_EXPLAIN}" onkeypress="if (event.keyCode==13){return false}" />
