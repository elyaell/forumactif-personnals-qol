...
<!-- ELYAELL : Modification des informations utilisateurs lors d'une recherche -->
...
$(function () {
  ...
  $(".switch-profile").each(function() {
    ...
    search_to_switch.find(".postsearch_infos .poster_name span").css('color', "#" + switch_current_class);
  });
});
</script>
<!-- ELYAELL : Modification des informations utilisateurs lors d'une recherche -->
